...
if($type == 'changetitle')
{
	...
	$title = $_POST['title'];
	//UPDATE calendar SET title='$title' and type='$ft' where id='$eventid'"
	//'UPDATE calendar SET title =\'abc\'  AND type =\'pdf\' WHERE id =0';
	$ft=$_POST['ft'];
	$sql  = "UPDATE calendar SET title ='$title' ,ftype ='$ft' WHERE id ='$eventid'";
